...
import (
	...
	coscontrollers "gitub.com/lburgazzoli/bf2-cos-fleetshard-go/controllers/cos"
...
func main() {
	...
	if _, err := coscontrollers.NewManagedConnectorReconciler(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "ManagedConnector")
		os.Exit(1)
	}
