...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ServiceResgistrySpec) DeepCopyInto(out *ServiceResgistrySpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ServiceResgistrySpec.
func (in *ServiceResgistrySpec) DeepCopy() *ServiceResgistrySpec {
	if in == nil {
		return nil
	}
	out := new(ServiceResgistrySpec)
